...
import { formatPrice, gifts as defaultGifts, totalGiftValue, type Gift, type GiftStatus } from "@/data/gifts";
import { loadGiftStatuses } from "@/lib/supabase-gifts";
...
function Index() {
  ...
  useEffect(() => {
    ...
    loadGiftStatuses().then((statuses) => {
      if (mounted) setGiftStatuses(statuses);
    });
